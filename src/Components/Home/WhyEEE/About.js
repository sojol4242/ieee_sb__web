  ...
  return (
    <div className="about__section section__padding mt-16" id="about">
      ...
      <div className="eee__features">
        <Facilities title="EEE Association" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
           <Facilities title="Rich Faculty Member" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
        <Facilities title="Laboratory" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
       
        <Facilities title="IEEE Student Branch" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
        <Facilities title="Research Club" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
        <Facilities title="Robogang" text=" Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit
          aperiam quia officia, repudiandae ex laborum."/>
      </div>
      <Stats/>
    </div>
